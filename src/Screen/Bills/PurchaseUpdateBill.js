...
const PurchaseUpdateBill = () => {
    ...
    const [invoiceNumber, setInvoiceNumber] = useState(recordData.invoiceNumber); const [productName, setProductName] = useState('');
    ...
    const handleDelete = async () => {
        try {
            ...
            const invoiceRef = doc(firestore, `dealers/${customerID}/invoices`, recordData.id);
    ...
    return (
        ...
        >
            <Grid id="container">
                <HeaderCompo title={"Update Deler Bill"} />
                <Grid >
                    <Grid >
                        <Grid>
                            <Flex style={{
                            ...
                            <datalist id="customerSuggestions">
                                {customers.map(customer => (
                                    <option key={customer.id} value={customer.customerName} data-mobile={customer.mobileNumber} />
                        ...
                        <Flex vertical style={{ justifyContent: 'space-between' }}>
                            <Grid style={{ justifyContent: 'center', alignItems: 'center', display: 'flex' }} >
                                Product Name:
                                <Input
                                ...
                                Sale Price:
                                <Input style={{ width: inputstyle }} type="number" id="price" name="price" value={productPrice} onChange={(e) => setProductPrice(e.target.value)} />
                                <label style={{ width: 'auto' }} htmlFor="price">Purchase Price: {selectedProduct ? selectedProduct.price : ''}</label>
                            ...
                            <Flex>
                                <label style={{ width: 'auto' }} htmlFor="quantity">Quantity (KG):</label>
                                <input type="number" id="quantity" name="quantity" value={quantity} onChange={handleQuantityChange} />
                                <label style={{ width: 'auto' }} htmlFor="amount">Amount:</label>
                ...
                <Col xs={24}>
                    <Flex>
                        Discount:
                        <Input style={{ width: inputstyle }} type="text" id="discount" name="discount" value={discount} onChange={(e) => setDiscount(e.target.value)} />

                        Labor:
                        <Input style={{ width: inputstyle }} type="number" id="labor" name="labor" value={labor} onChange={(e) => setLabor(e.target.value)} />
                    ...
                    <Flex>
                        ...
                        CGST (%):
                        <Input
                            style={{ width: inputstyle }} type="number"
                            id="cgstTax"
                            name="cgstTax"
                            value={cgstTax}
                ...
                <Flex align='center' justify='centeer'>
                    TotalBillAmmount:
                    <Input
                        type="text"
                        style={{ fontWeight: 'bold', width: inputstyle, fontSize: 20 }}
            ...
            <Grid id="Container2" style={{ padding: 0 }}>
                ...
                <div className="print-preview-container">
                    ...
                    <div className="invoice-details" style={{ display: 'flex', flexDirection: 'row-reverse', justifyContent: 'space-between' }}>
                        ...
                        <div style={{ display: 'flex', gap: 15 }} >
                            <p style={{ fontSize: 15 }}><strong>Customer Name:</strong> {invoiceData.customerName}</p>
...
export default PurchaseUpdateBill;
