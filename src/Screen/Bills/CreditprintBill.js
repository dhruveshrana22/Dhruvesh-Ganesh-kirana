...
const CreditPrintBill = () => {
    ...
    return (
        <Flex vertical style={{ padding: 20, justifyContent: 'center', alignItems: 'center' }}>
            <Grid id="Container2" style={{}}>
                <Flex justify="space-between">
                    <Button type='default' onClick={() => window.history.back()}>Back</Button>
                    <Button type='primary' onClick={handlePrint}>Print</Button>
                </Flex>
                <Grid className="print-preview-container">
                    ...
                    <Flex className="additional-details" style={{ justifyContent: 'space-between', marginTop: -20 }}>
